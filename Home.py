...
# Information about Critical Ratio, Heat Index, and Rainfall
    ...
    if st.button("Critical Ratio"):
        st.switch_page("/main/Water-Scarcity-Forecast/project/pages/Critical Ratio.py")
    ...
    if st.button("Heat Index"):
        st.switch_page("/main/Water-Scarcity-Forecast/project/pages/Heat Index.py")   
    ...
    if st.button("Rainfall"):
        st.switch_page("/main/Water-Scarcity-Forecast/project/pages/Rainfall.py")
